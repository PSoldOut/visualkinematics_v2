\section*{Abstract}
In this work, a framework for robot simulation is developed, which is used for teaching at the University of Applied Sciences Dortmund.  
...
Arbitrary robot models can be integrated into the framework via URDF descriptions, including robots with seven or more rotary joints,  
