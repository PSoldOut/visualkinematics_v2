...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/class_diagramm.png}
    \caption{UML-Klassendiagramm des Frameworks (vereinfacht)}
...
\begin{figure}[H]
    ...
    \caption{UML-Packagediagramm der Module (vereinfacht)}
