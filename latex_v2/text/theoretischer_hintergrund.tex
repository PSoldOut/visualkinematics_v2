...
als Konfiguration eines Systems. Diese kann durch einen Punkt $q$ dargestellt werden.
...
Die $x_0$- und $y_0$-Achse sind anschließend frei wählbar, unter der Bedingung dass die zugehörigen Einheitsvektoren $x_0, y_0$ und $z_0$ ein rechtshändiges Koordinatensystem bilden.
