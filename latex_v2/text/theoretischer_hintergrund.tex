...
Anschließend wird die Objektorientierte Struktur erklärt und welche Klassen zur sauberen Strukturierung erstellt worden sind.
Danach wird die Umsetzung der Animation erläutert und der Animationsalgorithmus präsentiert.
Danach wird darauf eingegangen wie die Benutzeroberfläche entwickelt worden ist, und wieso das Das Design so gewählt worden ist.
Danach wird erklärt wie die Denavit-Hartenberg-Konvention in das Framework eingebracht worden ist.
...
Die serielle Kinematik ist in der Industrie häufiger vertreten.
